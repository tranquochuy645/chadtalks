...
exports.multerUploadMany = exports.multerUpload = void 0;
...
const multerUploadMany = (0, multer_1.default)({ storage: storage }).array('files', 5);
exports.multerUploadMany = multerUploadMany;
